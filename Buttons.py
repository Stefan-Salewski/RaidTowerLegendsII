...
class Button():
    def __init__(self,x,y,image,hover_image,scale):
        ...
        self.image_hover = pygame.transform.scale(hover_image,(int(image_hover_width * scale), int(image_hover_height * scale)))
    ...
    def draw(self, screen_instance):
        ...
        if self.rect.collidepoint(pos):
            ...
            screen_instance.blit(self.image_hover, (self.rect.x, self.rect.y))
        else:
